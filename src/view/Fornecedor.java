...
public class Fornecedor extends JDialog {
	...
	public Fornecedor() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(Fornecedor.class.getResource("/img/9990432_snowman_doll_people_holiday_ice_icon.png")));
		...
		txtID.setColumns(10);
		txtID.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtRazaoSocial.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtFone.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtEmail.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtCEP.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtNumero.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtComplemento.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtBairro.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtCidade.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtReferencia.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnAdicionar.setIcon(new ImageIcon(Fornecedor.class.getResource("/img/useradd.png")));
		...
		btnEditar.setIcon(new ImageIcon(Fornecedor.class.getResource("/img/editnv.png")));
		...
		btnLimpar.setIcon(new ImageIcon(Fornecedor.class.getResource("/img/vasoura.png")));
		btnLimpar.setToolTipText("Limpar Campos");
		btnLimpar.setContentAreaFilled(false);
		btnLimpar.setBorder(null);
		btnLimpar.setBounds(412, 499, 60, 60);
		...
		txtCNPJ.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtFantasia.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtVendedor.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtSite.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		txtIE.setColumns(10);
		txtIE.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		txtIE.setBounds(122, 214, 290, 20);
		getContentPane().add(txtIE);

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(
				Fornecedor.class.getResource("/img/9989704_rating_evaluation_grade_ranking_rate_icon (1).png")));
