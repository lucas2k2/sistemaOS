...
public class Relatorios extends JDialog {
	 ...
	 */
	public Relatorios() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Relatorios.class.getResource("/img/9990432_snowman_doll_people_holiday_ice_icon.png")));
		...
		btnClientes.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnServicos.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		btnServicos.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnServicos.setContentAreaFilled(false);
		btnServicos.setIcon(new ImageIcon(Relatorios.class.getResource("/img/airgelado.png")));
		...
		btnEstoque.setIcon(new ImageIcon(Relatorios.class.getResource("/img/9022710_package_duotone_icon.png")));
		btnEstoque.setToolTipText("Clientes");
		btnEstoque.setContentAreaFilled(false);
		btnEstoque.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnValidade.setIcon(new ImageIcon(Relatorios.class.getResource("/img/5803966_checklist_clipboard_task_todo_icon.png")));
		btnValidade.setToolTipText("Clientes");
		btnValidade.setContentAreaFilled(false);
		btnValidade.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnPatrimonio.setIcon(new ImageIcon(Relatorios.class.getResource("/img/134157_money_cashier_dollar_currency_icon.png")));
		btnPatrimonio.setToolTipText("Clientes");
		btnPatrimonio.setContentAreaFilled(false);
		btnPatrimonio.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnServicos_1.setIcon(new ImageIcon(Relatorios.class.getResource("/img/61816_business_buyers_clients_users_icon.png")));
		btnServicos_1.setToolTipText("Serviços");
		btnServicos_1.setContentAreaFilled(false);
		btnServicos_1.setBorder(new TitledBorder(null, "", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	private void relatorioServicos() {
		...
		try {
			...
			String readClientes = "select\r\n"
					+ "servicos.os,servicos.dataOS,servicos.modelo,servicos.valor,\r\n"
